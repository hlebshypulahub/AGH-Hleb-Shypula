...
import hleb.ledikom.controller.myenum.ExemptionController;
...
public class ExemptionControllerTests {
    ...
    @Autowired
    private ExemptionController exemptionController;

    @Test
    @WithMockUser(username = "admin", roles = {"USER", "ADMIN"})
    public void Should_GetExemptionValues() {
        List<Map<String, String>> list = exemptionController.getExemptionValues();
